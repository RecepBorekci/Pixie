...
class Palette {
  static const MaterialColor purpleLight = const MaterialColor(
    ...
    const <int, Color>{
      ...
      100: const Color(0xfff1f2ff), //20%
      200: const Color(0xffe3e5fe), //30%
      300: const Color(0xffd5d8fe), //40%
      400: const Color(0xffc7cbfe), //50%
      500: const Color(0xffbabefe), //60%
      600: const Color(0xffacb1fd), //70%
      700: const Color(0xff9ea4fd), //80%
      800: const Color(0xff9097fd), //90%
      900: const Color(0xff828afc), //100%
    },
  );
